...
$(document).ready(function () {
   ...
   my.avatarUrl = function (relativePath) {
    ...
    my.getSubstring = function (string, start , end) {
        return string.substring(start, end);
    }

    my.getIndexOfItemInArray = function(array, item) {
        return array.indexOf(item);
    }

    my.getMatchInArray = function (array, checkElement, field) {
        var match = ko.utils.arrayFilter(array, function (item) {
            return item[field] === checkElement[field];
        });
        return match;
    }
