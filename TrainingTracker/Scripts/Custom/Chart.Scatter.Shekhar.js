...
(function (root, factory) {
    ...
    chartjs.ScatterDateScale = chartjs.ScatterNumberScale.extend({
        ...
        _calculateDateScaleRange: function (valueMin, valueMax, drawingSize, fontSize) {
            ...
            var maxSteps = drawingSize / (fontSize * 5);
    ...
    chartjs.ScatterDataSet = (function () {
        ...
        datasetCtr.prototype.addPoint = function (x, y, r) {
            ...
            var point = this._createNewPoint(y);
        ...
        datasetCtr.prototype._createNewPoint = function (y) {

            var pointStrokeColour = this.pointStrokeColor;
            if (typeof (y) != 'undefined') {
                switch(y) {
                    case 1:
                    {
                        pointStrokeColour = 'red';
                        break;
                    }
                    case 2:
                        {
                            pointStrokeColour = 'orange';
                            break;
                        }
                    case 3:
                        {
                            pointStrokeColour = 'blue';
                            break;
                        }
                    case 4:
                        {
                            pointStrokeColour = 'green';
                            break;
                        }
                }
            }
            ...
            return new hlp.ScatterPoint({
                ...
                // colors
                strokeColor:pointStrokeColour || this.pointStrokeColor ,
                highlightStroke:pointStrokeColour || this.pointColor,
                fillColor: pointStrokeColour || this.pointColor,
                highlightFill: pointStrokeColour || this.pointStrokeColor
            });
        };
