...
namespace TrainingTracker.DAL.Repositories
{
    public class ForumUserHelpPostRepository : Repository<ForumUserHelpPost>, IForumUserHelpPostRepository
    {
        ...
        public PagedResult<ForumUserHelpPost> GetPagedFilteredPosts(string wildcard, int categoryId, int statusId, int searchPostId,
            int pageNumber, int pageSize)
        {
            return BaseFilterSearchQuery(wildcard, categoryId, statusId, searchPostId).Page(pageNumber, pageSize);
        }

        private IQueryable<ForumUserHelpPost> BaseFilterSearchQuery(string wildcard, int categoryId, int statusId, int searchPostId)
        {
